...
class HumansVsGoblins {
    ...
    public static int humanPos;
    public static int goblinPos;
    ...
    public static void main (String[] args) {
        ...
        do {
            ...
            while(true){
                ...
                placePiece(land, goblinPos, "goblin");
                printGameBoard(land);
                // System.out.println("Goblin(@) has moved to the next position.");
    ...
    public static void printGameBoard(char[][] land) {
    ...
    public static void placePiece(char[][] land, int pos, String user) {
