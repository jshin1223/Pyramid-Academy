...
public abstract class Ship {
    ...
    public static void Setting() {
        ...
        System.out.println("Battleship Multilayer\n" +
                "Enter Player 1 name:");
    ...
    public static void placeTargetHuman ( char[][] seaCPU){
        ...
        if (seaCPU[realShipTargetRowH][realShipTargetColumnH] == 'D' ||
                ...
                System.out.println("===> " + getPlayer1Name() + " hit a " + getPlayer2Name() + "'s" + " ship! (X added)");
                ...
                System.out.println("~~~> " + getPlayer1Name() + " missed a target! (M added)");
    ...
    public static void placeTargetCPU ( char[][] seaHuman){
            ...
            if (seaHuman[realShipTargetRowC][realShipTargetColumnC] == 'D' ||
                ...
                System.out.println("===> " + getPlayer2Name() + " hit a human ship! (X added)\n");
                seaHuman[realShipTargetRowC][realShipTargetColumnC] = 'X';

            } else {
                System.out.println("~~~> " + getPlayer2Name() + " missed a target! (M added)\n");
